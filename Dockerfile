...
# docker build -t aljam3 .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name aljam3 aljam3
...
RUN DEPLOY=1 SECRET_KEY_BASE_DUMMY=1 ./bin/rails assets:precompile
