                    ...
                    TableCell(class: "text-center") do
                      Button(
                        ...
                        data: {
                          ...
                          file_download_url_value: (file_info[:url] if hotwire_native_app?),
                          file_download_filename_value: ("#{file.book.title} - #{file.name}.#{file_info[:extension]}" if hotwire_native_app?),
                          file_download_loading_status_value: (capture { render Lucide::LoaderCircle.new(class: "size-3.5 animate-spin") } if hotwire_native_app?),
