  ...
  connect() {
    ...
    this.select = new TomSelect(this.element, {
      ...
      render: {
        ...
        option: (data, escape) => {
          return '<div class="px-2! py-1.5! text-sm! rounded-sm! outline-none! transition-colors! cursor-pointer! hover:bg-accent! hover:text-accent-foreground! focus:bg-accent! focus:text-accent-foreground! aria-selected:bg-accent! aria-selected:text-accent-foreground!">' + escape(data.name) + '</div>'
        }
      },
